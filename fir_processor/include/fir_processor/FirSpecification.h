...
struct Parameters {
    static constexpr uint32_t FirMessage = 0xBB81EC22;
    uint32_t ThisMessage {FirMessage};

    uint32_t ir_index {};
};

struct Specification {
    static constexpr uint32_t FirConstructionType = 0xAC90FB31;
    uint32_t ThisType {FirConstructionType};
