...
#ifndef FIR_FIR_DEVICE_CODE_PROVIDER_H
#define FIR_FIR_DEVICE_CODE_PROVIDER_H
...
class FirDeviceCodeProvider : public GPUA::processor::v2::DeviceCodeProvider {
public:
    FirDeviceCodeProvider(const GPUA::processor::v2::DeviceCodeSpecification& specification);
    ~FirDeviceCodeProvider() override = default;

    // Copy ctor and copy assignment are deleted along with move assignment operator deletion
    FirDeviceCodeProvider& operator=(FirDeviceCodeProvider&&) noexcept = delete;
...
#endif // FIR_FIR_DEVICE_CODE_PROVIDER_H
