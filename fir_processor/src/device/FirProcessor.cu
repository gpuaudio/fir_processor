...
DeclareProcessorStep(FirProcessor::FirProcessorDevice<float>, 0, process, float, fir::ProcessorParameter, void);
DeclareProcessor(FirProcessor::FirProcessorDevice<float>, 1);
